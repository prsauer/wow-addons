...
//   /**
//    * Ids of spells affected by this spell
//    */
//   affectingSpellIds: number[];
//   gcd: string;
//   class: string;
//   duration: string;
//   cooldown: string;
//   charges: string;
//   /**
//    * Azerite power id -- used to help filter Azerite powers out
//    */
//   azeritePowerId: string;
//   /**
//    * Ids of spells that trigger this spell
//    */
//   triggerSpellIds: number[];

//   /**
//    * List of pvp modifiers on effects of this spell
//    */
//   pvpCoeffs: PvPModifier[];
//   worstPvPCoefficient?: PvPModifier;
//   /**
//    * The worst PvP modifier for each spell id on the affecting spell ids list
//    * Used to determine modifiers that are "inherited" by spell ids that affect other spell ids
//    */
//   inheritedPvpNerfs: PvPModifier[];

//   remap: PvPModifier[][];
// };

// const spellObjects: Record<string, SpellObject> = {};
...
//     o.remap = o.triggerSpellIds.map(
//       (tId) => spellObjects[tId].inheritedPvpNerfs
//     );
//     o.triggerSpellIds.forEach((tId) => {
//       if (o.worstPvPCoefficient) {
//         spellObjects[tId].inheritedPvpNerfs = spellObjects[
//           tId
//         ].inheritedPvpNerfs.concat([[o.info.spellId, o.worstPvPCoefficient]]);
//       }
//       spellObjects[tId].inheritedPvpNerfs = spellObjects[
//         tId
//       ].inheritedPvpNerfs.concat(o.inheritedPvpNerfs);
//     });
//   }
// });
...
//     .map(
//       (n) =>
//         `Affected by ${makeRed(nerfCoeffToString(n[1][0]))} nerf to ${
//           spellObjects[n[0]].info.spellName
//         }'s ${n[1][1]} effect\n`
//     );
//   let nerfStrings = [...new Set(nerfEffects)].join("");
//   if (o.worstPvPCoefficient && o.worstPvPCoefficient[0] < 1) {
//     nerfStrings =
//       `A ${makeRed(nerfCoeffToString(o.worstPvPCoefficient[0]))} nerf to ${
//         o.worstPvPCoefficient[1]
//       } effect\n` + nerfStrings;
//   }
//   if (nerfStrings) {
//     lualines =
//       lualines +
//       `[${o.info.spellId}] = {["edits"] = {}, ["text"] = "${nerfStrings.replace(
//         /\n/g,
//         "\\n"
//       )}"},\n`;
//   }
